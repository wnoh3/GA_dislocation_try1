...
function H=evaluation(Pnm_2_11_full,Qnm_2_11_full,Rnm_2_11_full,Snm_2_11_full,...
...
for i = 1:pages
    ...
    %assign pages
    Pnm_2_11 = Pnm_2_11_full(:,:,pages);
    Qnm_2_11 = Qnm_2_11_full(:,:,pages);
    Rnm_2_11 = Rnm_2_11_full(:,:,pages);
    Snm_2_11 = Snm_2_11_full(:,:,pages);

    Pnm_2_12 = Pnm_2_12_full(:,:,pages);
    Qnm_2_12 = Qnm_2_12_full(:,:,pages);
    Rnm_2_12 = Rnm_2_12_full(:,:,pages);
    Snm_2_12 = Snm_2_12_full(:,:,pages);

    Pnm_2_22 = Pnm_2_22_full(:,:,pages);
    Qnm_2_22 = Qnm_2_22_full(:,:,pages);
    Rnm_2_22 = Rnm_2_22_full(:,:,pages);
    Snm_2_22 = Snm_2_22_full(:,:,pages);
