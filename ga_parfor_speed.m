...
%--------------------------------------------------------------------------
p=20; % Population size: 100 Chromosomes with (n x m) matrix
...
fpname = strcat('Jan9_test_parfor_speed_pop',num2str(p),'_tg',num2str(tg));
...
[Opt_S11,Opt_S12,Opt_S22] = plot_fourier(Optimal_solution_P_11,Optimal_solution_Q_11,Optimal_solution_R_11,Optimal_solution_S_11,...
...
%%
diff_S11 = readmatrix(strcat(MD_path,'_S11'))-Opt_S11;
diff_S12 = readmatrix(strcat(MD_path,'_S12'))-Opt_S11;
diff_S22 = readmatrix(strcat(MD_path,'_S22'))-Opt_S11;

%%
figName= 'diff S11 Contours';
f = figure('Name', figName ,'visible','on');
image(diff_S11,'CDataMapping','scaled')
...
f = figure('Name', figName ,'visible','on');
image(diff_S12,'CDataMapping','scaled')
...
f = figure('Name', figName ,'visible','on');
image(diff_S22,'CDataMapping','scaled')
